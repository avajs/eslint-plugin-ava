...
❌ This rule is [deprecated](https://github.com/avajs/eslint-plugin-ava/blob/main/docs/rules/no-duplicate-modifiers.md). Replaced by `ava/no-invalid-modifier-chain` which covers more cases.
